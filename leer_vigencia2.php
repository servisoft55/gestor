<!-- CERTIFICACION DE VIGENCIA 2 PÁGINA (INCLUYE CONFORME CON SU MATRIZ) -->
<!doctype html>
<html lang="es">
<head>
	<meta charset="UTF-8">
...
function acentos2($texto) {
	...
	$texto = str_replace("&l1S","",$texto);
	$texto = str_replace("G","",$texto);
	$texto = str_replace("CERTIFICADOS","<br/><br/><div class='titulo'><b><u>C E R T I F I C A D O S</u></b></div>".$imagen,$texto);
	$texto = str_replace("============","",$texto);
	$texto = str_replace(" CHILLAN","<strong>CHILLAN</strong>",$texto);
	$texto = str_replace("","",$texto);
	$texto = str_replace("CERTIFICADO DE INSCRIPCION","<div class='titulo'><b><u>CERTIFICADO DE INSCRIPCION</u></b></div><br><br><br>",$texto);
