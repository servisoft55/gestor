...
fnStateSave:function(e,i){this.oApi._fnCreateCookie(e.sCookiePrefix+e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primero",sLast:"Ultimo",sNext:"Siguiente",sPrevious:"Previo"},sEmptyTable:"No data available in table",
sInfo:"Mostrar _START_ de _END_ de _TOTAL_ Registros",sInfoEmpty:"Mostrar 0 de 0 de 0 Registros",sInfoFiltered:"(filtrado de _MAX_ Registros totales)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Mostrar _MENU_ Registros",sLoadingRecords:"Loading...",sProcessing:"Procesando...",sSearch:"Buscar:",sUrl:"",sZeroRecords:"No matching records found"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",
